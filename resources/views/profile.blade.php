                ...
                <div class="card-body">
                    <form method="POST" action="/profile/edit" enctype='multipart/form-data'>
                        ...
                        <div class="col row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" value="{{ old('password', $users->password) }}" name="password" required autocomplete="new-password">
